...
@celery_app.task(bind=True, base=PlanTask, name="plan.generate", max_retries=3, default_retry_delay=60)
def generate_plan(self, project_id: str, options: Dict[str, Any]) -> Dict[str, Any]:
    ...
    try:
        ...
        # Generate plan
        plan = PlanService.generate_plan(self.db, project_uuid, plan_request)
