...
from app.models import Project, Requirement, RequirementQuestion, RequirementIteration
        ...
        for req in requirements:
            ...
            if questions_needed:
                ...
                for question_text in questions_needed:
                    existing_q = self.db.query(RequirementQuestion).filter(
                        RequirementQuestion.requirement_id == req.id,
                        RequirementQuestion.question == question_text
                    ).first()
...
# backend/app/workers/tasks/requirements.py (continued)
                ...
                last_iteration = self.db.query(RequirementIteration).filter(
