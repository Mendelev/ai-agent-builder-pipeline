...
@celery_app.task(bind=True, base=PromptTask, name="prompts.generate", max_retries=3, default_retry_delay=60)
def generate_prompts(self, project_id: str, plan_id: Optional[str], include_code: bool) -> Dict[str, Any]:
    """
    ...
    try:
        ...
        # Create request
        request = PromptGenerateRequest(include_code=include_code, plan_id=plan_uuid)

        # Generate prompts
        bundle = PromptService.generate_prompts(self.db, project_uuid, request)
