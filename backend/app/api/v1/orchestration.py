...
from app.core.observability import get_logger, correlation_id_var
...
from app.models.orchestration import EventType, AgentType
...
async def get_audit_logs(
    ...
    try:
        ...
        result = OrchestrationService.get_audit_logs(
            db, project_id, page, page_size, event_type_enum
        )
